<template>
  <section>
    ...
    <!--新增界面-->
    <el-dialog title="添加题目" size="large" v-model="addFormVisible" :close-on-click-modal="false">
      <el-form :model="addForm" label-width="120px" :rules="addFormRules" ref="addForm">
        <el-form-item label="题目说明" prop="title">
          <el-input v-model="addForm.title" auto-complete="off"></el-input>
        </el-form-item>
        <el-form-item label="选项" prop="zone_id">
          <div class="option-item" v-for="(option, index) in addRadio_form.options">
            <el-row>
              <el-col span="18">
                <el-input v-model="option.content" :key="index" placeholder="请输入选项内容"
                       style="display:inline-block"></el-input>
              </el-col>
              <el-col span="6">
                <div class="option-btn">
                  <el-button type="success" icon="plus-round" size="small"
                          @click="addOption(addRadio_form.options)"></el-button>
                  <el-button type="warning" icon="close" size="small"
                          @click="delOption(addRadio_form.options,index)"></el-button>
                </div>
              </el-col>
            </el-row>
          </div>
