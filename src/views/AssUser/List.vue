  ...
  export default {
    ...
    methods: {
      ...
      async getListData () {
        ...
        const res = await this.$http.post(`${MODEL_NAME}/dlist`, params)
...
//      },
      ...
      handleDel (index, row) {
        this.$confirm('确认删除该记录吗?', '提示', {
          ...
          const res = await this.$http.post(`${MODEL_NAME}/dstatus`, params)
          if (res === null) return
          this.$message({
            message: '状态修改成功',
            type: 'success'
      ...
      async handleEdit (index, row) {
        console.log(this.$route.path)
        this.$router.push(`${this.$route.path}/dedit/${row.id}`)
      },
      // 显示新增界面
      handleAdd () {
        console.log(`${this.$route.path}/${this.$route.params.uid}/dadd`)
        this.$router.push(`${this.$route.path}/dadd`)
      },
      // 修改状态
