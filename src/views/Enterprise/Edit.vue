...
<script>
  ...
  const MODEL_NAME = 'Enterprise' // http://api.zhongjiao.kfw001.com/webadmin/控制器/方法 -> 接口控制器名称
...
//          this.formData.end_time = ''
          ...
          this.formData.start_time = this.formData.onsite_time[0] * 1000
          this.formData.end_time = this.formData.onsite_time[1] * 1000
        }
      },
      async getArrayData () {
          ...
          if (valid) {
            this.$confirm('确认提交吗？', '提示', {}).then(async () => {
              ...
              let params = Object.assign({
                p_id: this.$route.params.pid,
                onsite_id: this.$route.params.onsite_id
              }, this.formData
              )
